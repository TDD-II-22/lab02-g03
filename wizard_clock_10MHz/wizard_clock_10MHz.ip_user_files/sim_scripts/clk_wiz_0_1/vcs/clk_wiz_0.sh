...
#
# Generated by Vivado on Sun Aug 21 19:15:21 -0600 2022
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../wizard_clock_10MHz.srcs/sources_1/ip/clk_wiz_0_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../wizard_clock_10MHz.srcs/sources_1/ip/clk_wiz_0_1" \
    "$ref_dir/../../../../wizard_clock_10MHz.srcs/sources_1/ip/clk_wiz_0_1/clk_wiz_0_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
