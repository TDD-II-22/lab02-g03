...
ISEStep( "vivado",
         "-log top_maquina_estado_calcu_con_teclado2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_maquina_estado_calcu_con_teclado2.tcl -notrace" );
