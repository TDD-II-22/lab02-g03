...
ISEStep( "vivado",
         "-log top_maquina_estado_calcu_sin_teclado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_maquina_estado_calcu_sin_teclado.tcl" );
