...
ISEStep( "vivado",
         "-log top_maquina_estado_calcu_con_teclado.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_maquina_estado_calcu_con_teclado.tcl" );
