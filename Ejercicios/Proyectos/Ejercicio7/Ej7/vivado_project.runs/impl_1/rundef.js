...
ISEStep( "vivado",
         "-log top_maquina_estado_calcu_sin_teclado.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_maquina_estado_calcu_sin_teclado.tcl -notrace" );
