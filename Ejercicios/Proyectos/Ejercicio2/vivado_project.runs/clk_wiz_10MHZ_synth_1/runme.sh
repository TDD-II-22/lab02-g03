...
HD_PWD='C:/TDD/lab02-g03/Teclado/wizard_clock_10MHz/wizard_clock_10MHz.runs/clk_wiz_10MHZ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_wiz_10MHZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_wiz_10MHZ.tcl
