...
HD_PWD='D:/VIVADO/PROY2/lab02-g03/Ejercicios/Proyectos/Ejercicio5/vivado_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_program_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_program_counter.tcl
