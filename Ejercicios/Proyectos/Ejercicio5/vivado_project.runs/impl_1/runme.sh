...
HD_PWD='D:/VIVADO/PROY2/lab02-g03/Ejercicios/Proyectos/Ejercicio5/vivado_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_program_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_module_program_counter.tcl -notrace
