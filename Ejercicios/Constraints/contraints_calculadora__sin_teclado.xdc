...
set_property PACKAGE_PIN U9 [get_ports teclado_pi[0]]
set_property IOSTANDARD LVCMOS33 [get_ports teclado_pi[0]]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {teclado_pi[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {teclado_pi[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {teclado_pi[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {teclado_pi[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {teclado_pi[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {teclado_pi[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports {sw[2]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {sw[2]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
#set_property PACKAGE_PIN V7 [get_ports {sw[3]}]
...
#set_property PACKAGE_PIN T8 [get_ports {led_error_po}]
...
#set_property PACKAGE_PIN K6 [get_ports led_error_po]
#set_property IOSTANDARD LVCMOS33 [get_ports led_error_po]
...
set_property PACKAGE_PIN E16 [get_ports en_tecla]
set_property IOSTANDARD LVCMOS33 [get_ports en_tecla]
##Bank = 15, Pin name = IO_L14P_T2_SRCC_15,					Sch name = BTNU
#set_property PACKAGE_PIN F15 [get_ports btn_start]
