...
set_property IOSTANDARD LVCMOS33 [get_ports {pc_i[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {pc_i[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pc_i[5]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {pcinc_o[4]}]
##Bank = 34, Pin name = IO_L12N_T1_MRCC_34,					Sch	name = LED5
set_property PACKAGE_PIN T4 [get_ports {pcinc_o[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pcinc_o[5]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {pc_o[4]}]
##Bank = 34, Pin name = IO_L7P_T1_34,						Sch name = LED13
set_property PACKAGE_PIN U1 [get_ports {pc_o[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pc_o[5]}]
##Bank = 34, Pin name = IO_L15N_T2_DQS_34,					Sch name = LED14
set_property PACKAGE_PIN R2 [get_ports {flag_ver[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {flag_ver[1]}]
##Bank = 34, Pin name = IO_L15P_T2_DQS_34,					Sch name = LED15
set_property PACKAGE_PIN P2 [get_ports {flag_ver[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {flag_ver[0]}]
...
#set_property PACKAGE_PIN F6 [get_ports flag_ver]
#set_property IOSTANDARD LVCMOS33 [get_ports flag_ver]
...
create_generated_clock -name from_PLL -source [get_ports clk] -divide_by 10 [get_pins clk_10mhz/CLK_10MHZ]
